...
if(isset($_POST['btn-add'])) {
    $name = $_POST['name'];
    $slug = $_POST['slug'];
    $parent_id = $_POST['parent_id']; // Giá trị 0 hoặc ID cha
    $sort_order = $_POST['sort_order'];
    $description = $_POST['description'];
    $image_url = $_POST['image_url'];

    if($catModel->addCategory($name, $slug, $parent_id, $sort_order, $description, $image_url)) {
        header("Location: category.php?success=added");
    } else {
        $error = "Có lỗi xảy ra, vui lòng kiểm tra lại slug (không được trùng).";
    }
}
?>
<!DOCTYPE html>
      ...
      <div class="col-12">
        <div class="card shadow-lg">
          <div class="card-header pb-0 text-left">
            <h3 class="font-weight-bolder text-info text-gradient">Thêm danh mục mới</h3>
            <p class="mb-0">Tạo danh mục cha hoặc danh mục con cho hệ thống</p>
          </div>
          <div class="card-body">
            ...
            <form role="form" method="POST">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="cat_name" class="form-control" placeholder="Ví dụ: Đất Sạch" required onkeyup="generateSlug()">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="slug" id="cat_slug" class="form-control" placeholder="dat-sach" required>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Link ảnh đại diện danh mục</label>
              ...
              <div class="d-flex justify-content-end mt-4">
                <a href="category.php" class="btn btn-light m-0">Hủy bỏ</a>
                <button type="submit" name="btn-add" class="btn bg-gradient-info ms-2 m-0">Lưu danh mục</button>
              </div>
            </form>
          </div>
        </div>
