        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
              <h6>Bảng sản phẩm</h6>
              <a href="add-product.php" class="btn btn-sm bg-gradient-info">Thêm sản phẩm mới</a>
            </div>
                    ...
                    <tr style="text-align: center;">
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?php echo $p['image_url']; ?>" class="avatar avatar-sm me-3" alt="product_img">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo number_format($p['price']); ?>đ</p>
                        <p class="text-xs text-secondary mb-0"><del><?php echo number_format($p['discount_price']); ?>đ</del></p>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $p['quantity']; ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <?php if ($p['state'] == 'còn hàng'): ?>
                          <span class="badge badge-sm bg-gradient-success">Còn hàng</span>
                        <?php else: ?>
                          <span class="badge badge-sm bg-gradient-secondary"><?php echo $p['state']; ?></span>
                        <?php endif; ?>
                      </td>
                      <td class="align-middle" style="padding-left: 3%;">
                        <a href="edit-product.php?id=<?php echo $p['id']; ?>" class="text-secondary font-weight-bold text-xs me-3">Sửa</a>
                        <a href="delete-product.php?id=<?php echo $p['id']; ?>" class="text-danger font-weight-bold text-xs" onclick="return confirm('Bạn có chắc muốn xóa?')">Xóa</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
