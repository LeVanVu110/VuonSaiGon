...
if (isset($_POST['btn-add'])) {
    ...
    if ($flashModel->add($_POST['name'], $_POST['start_time'], $_POST['end_time'], $is_active)) {
        header("Location: flash-sale.php?success=add");
    }
}
        ...
        <div class="container-fluid py-4 text-start">
            <div class="card shadow-lg col-12">
                <div class="card-header pb-0">
                    <h3 class="font-weight-bolder text-info text-gradient">Thêm Sự kiện Flash Sale</h3>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="name" class="form-control"
                                    placeholder="VD: Sale Giáng Sinh 2025" required>
                            </div>
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="form-check form-switch ps-0">
                                    <input class="form-check-input mt-1 ms-auto" type="checkbox" name="is_active"
                                        value="1" checked>
                                    <label class="form-check-label ms-3">Kích hoạt ngay sự kiện này</label>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end mt-4">
                            <a href="flash-sale.php" class="btn btn-light m-0">Hủy</a>
                            <button type="submit" name="btn-add" class="btn bg-gradient-info ms-2 m-0">Lưu sự
                                kiện</button>
                        </div>
                    </form>
                </div>
