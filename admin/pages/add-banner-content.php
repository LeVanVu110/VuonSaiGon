...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 200px);">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/banner-content.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <main class="main-content position-relative min-vh-100 border-radius-lg" style="margin-left: 250px;">
      ...
      <div class="row">
        <div class="col-12"> <div class="card shadow-lg">
            <div class="card-header pb-0 text-left">
              <h3 class="font-weight-bolder text-info text-gradient">Thêm nội dung Banner mới</h3>
              <p class="mb-0">Nhập tiêu đề và nội dung chi tiết (có thể bao gồm mã HTML cho ảnh)</p>
            </div>
            <div class="card-body">
              <form role="form" action="add-banner-content-process.php" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="form-control-label">Tiêu đề (Title)</label>
                      <input type="text" name="tile" class="form-control" placeholder="Ví dụ: ĐỘI NGŨ" required>
                    </div>
                  </div>

                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="form-control-label">Nội dung chi tiết (Content)</label>
                      <p class="text-xs text-secondary italic">Mẹo: Bạn có thể chèn ảnh bằng cách dán link dạng: src="https://link-anh.jpg"</p>
                      <textarea name="conntent" class="form-control" rows="15" placeholder="Nhập nội dung tại đây..." required></textarea>
                    </div>
                  </div>
                </div>

                <div class="d-flex justify-content-end mt-4">
                  <a href="banner-content.php" class="btn btn-light m-0">Hủy bỏ</a>
                  <button type="submit" name="btn-add" class="btn bg-gradient-info m-0 ms-2">Lưu nội dung</button>
                </div>
              </form>
            </div>
          </div>
