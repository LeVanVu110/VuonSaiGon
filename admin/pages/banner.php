                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between">
                            ...
                            <a href="add-banner.php" class="btn bg-gradient-info btn-sm">Thêm Banner mới</a>
                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 ps-3">
                                                    <?php echo $b['banner_id']; ?></p>
                                            </td>
                                            <td>
                                                <img src="<?php echo $b['image']; ?>" class="avatar avatar-xxl me-3"
                                                    style="width:300px!important; height:auto!important; border-radius:10px">
                                            </td>
                                            <td class="align-middle">
                                                <span class="text-xs text-secondary font-weight-bold">
                                                    <code class="text-dark bg-light p-1 border-radius-sm"
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="edit-banner.php?id=<?php echo $b['banner_id']; ?>"
                                                    class="text-secondary font-weight-bold text-xs"
                                                    data-toggle="tooltip">Sửa</a> |
                                                <a href="delete-banner.php?id=<?php echo $b['banner_id']; ?>"
