...
$titles = $titleModel->getArticleTitlesPage($page, $perPage, $keyword);
$totalPages = ceil($titleModel->getTotal($keyword) / $perPage);
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 200px);">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/article-title.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <div class="card mb-4 shadow-lg">
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
      <h6>Quản lý Chi tiết Mục lục Bài viết</h6>
      <div class="d-flex">
        <form method="GET" class="me-3">
          <input type="text" name="keyword" class="form-control" placeholder="Tìm tiêu đề mục..." value="<?= htmlspecialchars($keyword) ?>">
        </form>
        <a href="add-article-title.php" class="btn bg-gradient-info btn-sm mb-0">Thêm mục mới</a>
      </div>
    </div>
    <div class="card-body px-0 pt-0 pb-2 text-start">
      <div class="table-responsive p-0">
        <table class="table align-items-center mb-0">
          <thead>
            <tr>
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tiêu đề mục (Title)</th>
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thuộc bài viết</th>
              ...
              <td>
                <div class="d-flex px-3">
                  <h6 class="mb-0 text-sm">
                    <?= ($t['parent_id'] > 0) ? "— " . $t['title'] : "<strong>" . $t['title'] . "</strong>" ?>
                  </h6>
                </div>
              </td>
              <td><p class="text-xs font-weight-bold mb-0"><?= $t['post_name'] ?></p></td>
              <td class="align-middle text-center">
                <span class="badge badge-sm <?= ($t['parent_id'] == 0) ? 'bg-gradient-success' : 'bg-gradient-secondary' ?>">
                  <?= ($t['parent_id'] == 0) ? 'Mục chính' : 'Mục con' ?>
                </span>
              </td>
              <td class="align-middle">
                <a href="edit-article-title.php?id=<?= $t['article_title_id'] ?>" class="text-info font-weight-bold text-xs me-3">Sửa</a>
                <a href="delete-article-title.php?id=<?= $t['article_title_id'] ?>" class="text-danger font-weight-bold text-xs" onclick="return confirm('Xóa mục này?')">Xóa</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
