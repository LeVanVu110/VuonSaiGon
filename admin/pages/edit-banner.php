...
// 1. Lấy thông tin banner hiện tại
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
if (isset($_POST['btn-edit'])) {
    ...
    if ($bannerModel->updateBanner($id, $image_url)) {
        header("Location: banner.php?success=updated");
    } else {
   ...
   <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 200px);">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/banner.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class="card-body">
                            ...
                            <form role="form" method="POST">
                                <div class="form-group">
                                    <label>Đường dẫn hình ảnh mới (URL)</label>
                                    <input type="text" name="image_url" class="form-control"
                                        value="<?php echo $b['image']; ?>" required>
                                </div>

                                <div class="mt-4">
                                    <label>Hình ảnh hiện tại:</label>
                                    <div class="p-2 border-radius-lg bg-gray-100 text-center">
                                        <img src="<?php echo $b['image']; ?>" class="img-fluid border-radius-lg shadow"
                                            style="max-height: 300px; object-fit: contain;">
                                    </div>
                                </div>

                                <div class="d-flex justify-content-end mt-4">
                                    <a href="banner.php" class="btn btn-light m-0">Hủy bỏ</a>
                                    <button type="submit" name="btn-edit" class="btn bg-gradient-info ms-2 m-0">Lưu thay
                                        đổi</button>
                                </div>
                            </form>
                        </div>
