...
$banners = $introModel->getBannerIntroPage($page, $perPage, $keyword);
$total = $introModel->getTotal($keyword);
...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 200px);">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="../pages/banner-intro.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <div class="card mb-4 shadow-lg">
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
      <h6>Quản lý Banner Giới Thiệu</h6>
      <div class="d-flex">
        <form method="GET" class="me-3">
          <input type="text" name="keyword" class="form-control" placeholder="Tìm kiếm link ảnh..." value="<?= $keyword ?>">
        </form>
        <a href="add-banner-intro.php" class="btn bg-gradient-info btn-sm mb-0">Thêm mới</a>
      </div>
    </div>
        ...
        <table class="table align-items-center mb-0">
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Đường dẫn URL</th>
              <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Hiển thị (On/Off)</th>
          ...
          <tbody>
            ...
            <tr>
              <td><p class="text-xs font-weight-bold mb-0 ps-3"><?= $b['banner_id'] ?></p></td>
              <td><img src="<?= $b['image'] ?>" class="avatar avatar-xxl border-radius-lg" style="width:120px; height:auto; object-fit:cover"></td>
              <td><code class="text-xs bg-light p-1 border-radius-sm"><?= substr($b['image'], 0, 50) ?>...</code></td>
              <td class="align-middle text-center">
                <span class="badge badge-sm <?= $b['is_view'] ? 'bg-gradient-success' : 'bg-gradient-secondary' ?>">
                  <?= $b['is_view'] ? 'ON' : 'OFF' ?>
                </span>
              </td>
              <td class="align-middle text-center">
                <a href="edit-banner-intro.php?id=<?= $b['banner_id'] ?>" class="text-info font-weight-bold text-xs me-3">Sửa</a>
                <a href="delete-banner-intro.php?id=<?= $b['banner_id'] ?>" class="text-danger font-weight-bold text-xs" onclick="return confirm('Xóa?')">Xóa</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
