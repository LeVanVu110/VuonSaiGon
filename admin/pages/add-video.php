...
if (isset($_POST['btn-add'])) {
    ...
    $title = $_POST['title'];
    // Tự động tạo link ảnh thumbnail từ Youtube ID
    $image = "https://img.youtube.com/vi/{$yt_id}/hqdefault.jpg";
    $url = "https://youtu.be/{$yt_id}";

    if($videoModel->add($yt_id, $title, $image, $url)) {
        header("Location: video.php?success=add");
    }
}
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="card shadow-lg col-12">
    <div class="card-header pb-0">
      <h3 class="font-weight-bolder text-info text-gradient">Thêm Video YouTube Mới</h3>
    </div>
    <div class="card-body">
      <form method="POST">
        <div class="row">
          <div class="col-md-6">
            <label>YouTube ID (Ví dụ: VUIPoh_cJhM)</label>
            <input type="text" name="youtube_id" class="form-control mb-3" placeholder="Nhập mã ID sau v=" required>
          </div>
          <div class="col-md-6">
            <label>Tiêu đề Video</label>
            <input type="text" name="title" class="form-control mb-3" placeholder="Nhập tiêu đề hiển thị">
          </div>
        </div>
        <div class="d-flex justify-content-end mt-4">
          <a href="video.php" class="btn btn-light m-0">Hủy bỏ</a>
          <button type="submit" name="btn-add" class="btn bg-gradient-info m-0 ms-2">Lưu Video</button>
        </div>
      </form>
    </div>
  </div>
