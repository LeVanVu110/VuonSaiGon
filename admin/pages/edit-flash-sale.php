...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $event = $flashModel->getById($id);

    if (!$event) {
        header("Location: flash-sale.php");
        exit();
    }
}
...
if (isset($_POST['btn-edit'])) {
    ...
    if ($flashModel->update($id, $name, $start, $end, $is_active)) {
        header("Location: flash-sale.php?success=updated");
        exit();
    } else {
      ...
      <div class="col-12">
        <div class="card shadow-lg">
          <div class="card-header pb-0 text-left">
            <h3 class="font-weight-bolder text-info text-gradient">Sửa Sự kiện Flash Sale #<?php echo $id; ?></h3>
          </div>
          <div class="card-body">
              ...
              <div class="row text-start">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="datetime-local" name="start_time" class="form-control" 
                           value="<?php echo date('Y-m-d\TH:i', strtotime($event['start_time'])); ?>" required>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="datetime-local" name="end_time" class="form-control" 
                           value="<?php echo date('Y-m-d\TH:i', strtotime($event['end_time'])); ?>" required>
                  </div>
                </div>
                ...
                <div class="col-md-12 mt-3">
                  ...
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input mt-1 ms-auto" type="checkbox" name="is_active" value="1" 
                           id="is_active" <?php echo ($event['is_active'] == 1) ? 'checked' : ''; ?>>
                    <label class="form-check-label ms-3" for="is_active">Cho phép sự kiện này hoạt động trên web</label>
                  </div>
                </div>
              </div>

              <div class="d-flex justify-content-end mt-4">
                <a href="flash-sale.php" class="btn btn-light m-0 me-2">Quay lại</a>
                <button type="submit" name="btn-edit" class="btn bg-gradient-info m-0">Lưu thay đổi</button>
              </div>
            </form>
          </div>
        </div>
