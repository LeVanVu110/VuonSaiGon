          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              <div class="card-header text-center pt-4">
                ...
                <?php
                  if(isset($_GET['error'])){
                    if($_GET['error'] == 'exists') echo "<p class='text-danger text-sm'>Email này đã được sử dụng!</p>";
                    if($_GET['error'] == 'failed') echo "<p class='text-danger text-sm'>Có lỗi xảy ra, vui lòng thử lại.</p>";
                  }
                ?>
              </div>
              <div class="card-body">
                <form role="form text-left" action="register-process.php" method="POST">
                  <div class="mb-3">
                  ...
                  <div class="text-center">
                    <button type="submit" name="btn-register" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                  </div>
