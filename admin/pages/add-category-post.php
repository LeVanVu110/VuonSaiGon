...
if (isset($_POST['btn-add'])) {
    ...
    $result = $catPostModel->add($_POST['name'], $_POST['slug'], $_POST['sort_order']);
    if($result) header("Location: category-post.php?success=add");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="card shadow-lg col-12">
    <div class="card-header pb-0">
      <h3 class="font-weight-bolder text-info text-gradient">Thêm danh mục bài viết</h3>
    </div>
    <div class="card-body">
      <form method="POST">
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="name" class="form-control mb-3" placeholder="VD: Kỹ thuật nông nghiệp" required>
          </div>
          <div class="col-md-6">
            <label>Slug</label>
            <input type="text" name="slug" class="form-control mb-3" placeholder="VD: ky-thuat-nong-nghiep" required>
          </div>
          <div class="col-md-12">
        ...
        <div class="d-flex justify-content-end mt-4">
          <a href="category-post.php" class="btn btn-light m-0">Hủy bỏ</a>
          <button type="submit" name="btn-add" class="btn bg-gradient-info m-0 ms-2">Lưu danh mục</button>
        </div>
      </form>
    </div>
  </div>
