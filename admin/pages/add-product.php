                            ...
                            <form role="form" action="add-product-process.php" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" class="form-control mb-3"
                                            placeholder="Ví dụ: Đất sạch Orgamix" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Giá gốc (VNĐ)</label>
                                        <input type="number" name="price" class="form-control mb-3" placeholder="0"
                                            required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Giá giảm (VNĐ)</label>
                                        <input type="number" name="discount_price" class="form-control mb-3"
                                            placeholder="0">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Số lượng</label>
                                        <input type="number" name="quantity" class="form-control mb-3" value="0"
                                            required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="image_url" class="form-control mb-3"
                                ...
                                <div class="text-center">
                                    <button type="submit" name="btn-add"
                                        class="btn bg-gradient-info w-100 mt-4 mb-0">Lưu sản phẩm</button>
