...
$perPage = 8; // Hiển thị 8 sản phẩm 1 trang
$totalProducts = $productModel->getTotalProducts();
$totalPages = ceil($totalProducts / $perPage);

$products = $productModel->getAllProductsPage($page, $perPage);

// Hiển thị ra HTML...
foreach($products as $p) {
    // echo $p['name'] . " - " . number_format($p['price']) . " VNĐ<br>";
}
        ...
        <div class="col-lg-8 col-12 mx-auto">
          <div class="card shadow-lg">
            <div class="card-header pb-0 text-left">
              <h3 class="font-weight-bolder text-info text-gradient">Thêm sản phẩm mới</h3>
              <p class="mb-0">Nhập đầy đủ thông tin để đăng sản phẩm lên hệ thống</p>
            </div>
            <div class="card-body">
              <form role="form" action="add-product-process.php" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    <label>Tên sản phẩm</label>
                    <input type="text" name="name" class="form-control mb-3" placeholder="Ví dụ: Đất sạch Orgamix" required>
                  </div>
                  <div class="col-md-6">
                    <label>Giá gốc (VNĐ)</label>
                    <input type="number" name="price" class="form-control mb-3" placeholder="0" required>
                  </div>
                  <div class="col-md-6">
                    <label>Giá giảm (VNĐ)</label>
                    <input type="number" name="discount_price" class="form-control mb-3" placeholder="0">
                  </div>
                  <div class="col-md-6">
                    <label>Số lượng</label>
                    <input type="number" name="quantity" class="form-control mb-3" value="0" required>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" name="image_url" class="form-control mb-3" placeholder="https://..." required>
                  </div>
                  <div class="col-md-12">
                    <label>Sản phẩm đang giảm giá?</label>
                    <div class="form-check form-switch mb-3">
                      <input class="form-check-input" type="checkbox" name="is_sale" value="1">
                      <label class="form-check-label">Kích hoạt nhãn Sale</label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <label>Mô tả chi tiết</label>
                    <textarea name="description" class="form-control mb-3" rows="4" placeholder="Nhập thông tin sản phẩm..."></textarea>
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" name="btn-add" class="btn bg-gradient-info w-100 mt-4 mb-0">Lưu sản phẩm</button>
                  <a href="product.php" class="btn btn-outline-secondary w-100 mt-2">Quay lại</a>
                </div>
              </form>
            </div>
          </div>
