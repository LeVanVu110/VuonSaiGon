...
if (isset($_POST['btn-add'])) {
    ...
    if($bannerModel->addBanner($image_url)) {
        header("Location: banner.php?success=add");
    } else {
        $error = "Không thể thêm banner!";
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="col-12">
            <div class="card shadow-lg">
                <div class="card-header pb-0 text-left">
                    <h3 class="font-weight-bolder text-info text-gradient">Thêm Banner mới</h3>
                </div>
                <div class="card-body">
                    <form role="form" method="POST">
                        <label>Đường dẫn hình ảnh (URL)</label>
                        <input type="text" name="image_url" class="form-control mb-3" placeholder="Nhập link ảnh từ vuonsaigon.vn hoặc các nguồn khác..." required>
                        
                        <div class="text-center">
                            <button type="submit" name="btn-add" class="btn bg-gradient-info w-100 mt-4">Thêm ngay</button>
                            <a href="banner.php" class="btn btn-outline-secondary w-100 mt-2">Hủy bỏ</a>
                        </div>
                    </form>
                </div>
            </div>
