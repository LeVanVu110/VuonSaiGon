...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $category = $catPostModel->getById($id);

    if (!$category) {
        header("Location: category-post.php");
        exit();
    }
}
...
if (isset($_POST['btn-edit'])) {
    ...
    if ($catPostModel->update($id, $name, $slug, $sort_order)) {
        header("Location: category-post.php?success=updated");
        exit();
    } else {
    ...
    <div class="row">
      <div class="col-12"> <div class="card shadow-lg">
          <div class="card-header pb-0 text-left">
            <h3 class="font-weight-bolder text-info text-gradient">Sửa danh mục bài viết</h3>
            <p class="mb-0">Cập nhật thông tin cho danh mục: <strong><?php echo $category['name']; ?></strong></p>
          </div>
          <div class="card-body">
            ...
            <form role="form" method="POST">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="cat_name" class="form-control" 
                           value="<?php echo $category['name']; ?>" required onkeyup="generateSlug()">
                  </div>
                </div>

                <div class="col-md-6">
                  <div class="form-group">
                    <label>Slug (Đường dẫn sạch)</label>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Thứ tự sắp xếp (Càng nhỏ càng hiện trước)</label>
              ...
              <div class="d-flex justify-content-end mt-4">
                <a href="category-post.php" class="btn btn-light m-0">Quay lại</a>
                <button type="submit" name="btn-edit" class="btn bg-gradient-info m-0 ms-2">Cập nhật thay đổi</button>
              </div>
            </form>
          </div>
        </div>
