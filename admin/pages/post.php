...
$posts = $postModel->getPostsPage($page, $perPage, $keyword);
$totalPages = ceil($postModel->getTotal($keyword) / $perPage);
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="card mb-4 shadow-lg">
    <div class="card-header pb-0 d-flex justify-content-between">
      ...
      <div class="d-flex">
        ...
        <a href="add-post.php" class="btn bg-gradient-info btn-sm">+ Viết bài mới</a>
      </div>
    </div>
            ...
            <tr>
              <td>
                <div class="d-flex px-3 py-1">
                  <img src="<?= $p['image'] ?>" class="avatar avatar-sm me-3 border-radius-lg">
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm"><?= substr($p['title'], 0, 50) ?>...</h6>
                    <p class="text-xs text-secondary mb-0"><?= $p['slug'] ?></p>
                  </div>
                </div>
              </td>
              <td><span class="text-xs font-weight-bold"><?= $p['category_names'] ?></span></td>
              <td><p class="text-xs font-weight-bold mb-0"><?= $p['author'] ?></p></td>
              <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?= date('d/m/Y', strtotime($p['created_at'])) ?></span></td>
              <td class="align-middle">
                <a href="edit-post.php?id=<?= $p['post_id'] ?>" class="text-info font-weight-bold text-xs me-3">Sửa</a>
                <a href="delete-post.php?id=<?= $p['post_id'] ?>" class="text-danger font-weight-bold text-xs" onclick="return confirm('Xóa bài viết này?')">Xóa</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
