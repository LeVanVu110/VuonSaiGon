                    ...
                    <div class="card mb-4 shadow-lg">
                            ...
                            <div class="d-flex">
                                <form action="" method="GET" class="me-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="keyword" class="form-control" placeholder="Tìm tên..."
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-4 text-sm text-secondary">Không tìm
                                                thấy kết quả phù hợp.</td>
                                        </tr>
                                        <?php endif; ?>
                          ...
                          ?>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-sm <?php echo ($cat['parent_name']) ? 'bg-gradient-secondary' : 'bg-gradient-success'; ?>">
                                                    <?php echo $cat['parent_name'] ? $cat['parent_name'] : 'Danh mục gốc'; ?>
                                                </span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold"><?php echo $cat['sort_order']; ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <a href="edit-category.php?id=<?php echo $cat['id']; ?>"
                                                    class="text-info font-weight-bold text-xs me-3" title="Chỉnh sửa">
                                                    <i class="fas fa-edit"></i> Sửa
                                                </a>
                                                <a href="delete-category.php?id=<?php echo $cat['id']; ?>"
