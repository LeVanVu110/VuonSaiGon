<?php
session_start();
// Kiểm tra quyền Admin (Tùy chọn bảo mật của bạn)
        ...
        <div class="col-12">
          <div class="card shadow-lg">
            <div class="card-header pb-0 text-left">
              <h3 class="font-weight-bolder text-info text-gradient">Thêm Banner Giới Thiệu Mới</h3>
              <p class="mb-0">Banner này sẽ hiển thị trong phần giới thiệu của ứng dụng.</p>
            </div>
            <div class="card-body">
              <form role="form" action="add-banner-intro-process.php" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="form-control-label">Đường dẫn hình ảnh (URL)</label>
                      <input type="text" name="image" class="form-control" placeholder="https://example.com/banner.jpg" required>
                    </div>
                  </div>

                  <div class="col-md-12 mt-3">
                    <label class="form-control-label">Trạng thái hiển thị (is_view)</label>
                    <div class="form-check form-switch ps-0">
                      <input class="form-check-input mt-1 ms-auto" type="checkbox" name="is_view" value="1" id="is_view" checked>
                      <label class="form-check-label ms-3" for="is_view">Bật để hiển thị ngay lập tức</label>
                    </div>
                  </div>
                </div>

                <div class="d-flex justify-content-end mt-4">
                  <a href="banner-intro.php" class="btn btn-light m-0">Hủy bỏ</a>
                  <button type="submit" name="btn-add" class="btn bg-gradient-info m-0 ms-2">Lưu Banner</button>
                </div>
              </form>
            </div>
          </div>
