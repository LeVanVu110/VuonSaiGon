...
$contents = $contentModel->getBannerContentPage($page, $perPage, $keyword);
$total = $contentModel->getTotal($keyword);
        ...
        <div class="container-fluid py-4">
            <div class="card mb-4 shadow-lg">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6>Quản lý Nội dung Banner</h6>
                    <div class="d-flex">
                        <form method="GET" class="me-3">
                            <input type="text" name="keyword" class="form-control" placeholder="Tìm tiêu đề..."
                                value="<?= htmlspecialchars($keyword) ?>">
                        </form>
                        <a href="add-banner-content.php" class="btn bg-gradient-info btn-sm mb-0">+ Thêm mới</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0 ps-3"><?= $c['bannercontent_id'] ?></p>
                                    </td>
                                    <td>
                                        <h6 class="mb-0 text-sm"><?= $c['tile'] ?></h6>
                                    </td>
                                    <td>
                                        <p class="text-xs text-secondary mb-0"
                                            style="max-width: 500px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                            <?= strip_tags($c['conntent']) ?>
                                        </p>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="edit-banner-content.php?id=<?= $c['bannercontent_id'] ?>"
                                            class="text-info font-weight-bold text-xs me-3"><i class="fas fa-edit"></i>
                                            Sửa</a>
                                        <a href="delete-banner-content.php?id=<?= $c['bannercontent_id'] ?>"
                                            class="text-danger font-weight-bold text-xs"
                                            onclick="return confirm('Bạn có chắc muốn xóa nội dung này?')"><i
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination pagination-info justify-content-center">
                            ...
                            <li class="page-item <?= ($page == $i) ? 'active' : '' ?>">
                                <a class="page-link"
                                    href="?page=<?= $i ?>&keyword=<?= urlencode($keyword) ?>"><?= $i ?></a>
                            </li>
                            <?php endfor; ?>
                        </ul>
                    </nav>
