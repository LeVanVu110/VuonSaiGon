...
$id = $_GET['id'];
$p = $productModel->getProductById($id); // Lấy dữ liệu cũ để đổ vào Form
...
<body class="g-sidenav-show bg-gray-100">
  < <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
    ...
    <div class="card col-lg-8 mx-auto shadow-lg">
      <div class="card-header pb-0">
        <h3>Sửa sản phẩm: <?php echo $p['name']; ?></h3>
      </div>
      <div class="card-body">
        <form action="edit-product-process.php" method="POST">
          ...
          <input type="text" name="name" class="form-control mb-3" value="<?php echo $p['name']; ?>" required>
          
          <div class="row">
            <div class="col-md-6">
              <label>Giá gốc</label>
              <input type="number" name="price" class="form-control mb-3" value="<?php echo $p['price']; ?>" required>
            </div>
            <div class="col-md-6">
              <label>Giá giảm</label>
              <input type="number" name="discount_price" class="form-control mb-3" value="<?php echo $p['discount_price']; ?>">
            </div>
          </div>

          <label>Link ảnh</label>
          <input type="text" name="image_url" class="form-control mb-3" value="<?php echo $p['image_url']; ?>" required>

          <label>Trạng thái</label>
          <select name="state" class="form-control mb-3">
            <option value="còn hàng" <?php if($p['state'] == 'còn hàng') echo 'selected'; ?>>Còn hàng</option>
            <option value="hết hàng" <?php if($p['state'] == 'hết hàng') echo 'selected'; ?>>Hết hàng</option>
          </select>

          <div class="form-check form-switch mb-3">
            <input class="form-check-input" type="checkbox" name="is_sale" value="1" <?php if($p['is_sale'] == 1) echo 'checked'; ?>>
            <label class="form-check-label">Kích hoạt nhãn Sale</label>
          </div>

          <button type="submit" name="btn-edit" class="btn bg-gradient-info w-100">Cập nhật sản phẩm</button>
          <a href="product.php" class="btn btn-outline-secondary w-100 mt-2">Hủy</a>
        </form>
      </div>
    </div>
  </div>
