      ...
      <div class="col-12">
        <div class="card shadow-lg">
          <div class="card-header pb-0 text-left">
            <h3 class="font-weight-bolder text-info text-gradient">Chỉnh sửa Video #<?php echo $id; ?></h3>
          </div>
          <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="youtube_id" class="form-control" value="<?php echo $video['youtube_id']; ?>" required>
                ...
                <div class="col-md-12 mt-3">
                  ...
                  <div class="mb-3">
                    <img src="<?php echo $video['image']; ?>" class="border-radius-lg shadow" style="max-height: 200px;">
                  </div>
                </div>
              </div>
