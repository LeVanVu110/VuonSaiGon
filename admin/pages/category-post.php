...
$categories = $catPostModel->getCategoriesPage($page, $perPage, $keyword);
$total = $catPostModel->getTotal($keyword);
...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 200px);">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/category-post.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <div class="card mb-4 shadow-lg">
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
      <h6>Quản lý Danh mục Bài viết</h6>
      <div class="d-flex">
        <form method="GET" class="me-3">
          <input type="text" name="keyword" class="form-control" placeholder="Tìm tên danh mục..." value="<?= htmlspecialchars($keyword) ?>">
        </form>
        <a href="add-category-post.php" class="btn bg-gradient-info btn-sm mb-0">+ Thêm danh mục</a>
      </div>
    </div>
        ...
        <table class="table align-items-center mb-0 text-center">
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thứ tự</th>
          ...
          <tbody>
            ...
            <tr>
              <td><p class="text-xs font-weight-bold mb-0"><?= $c['cat_id'] ?></p></td>
              <td><h6 class="mb-0 text-sm"><?= $c['name'] ?></h6></td>
              <td><span class="text-xs font-weight-bold text-secondary"><?= $c['slug'] ?></span></td>
              <td><span class="text-xs font-weight-bold"><?= $c['sort_order'] ?></span></td>
              <td class="align-middle">
                <a href="edit-category-post.php?id=<?= $c['cat_id'] ?>" class="text-info font-weight-bold text-xs me-3"><i class="fas fa-edit"></i> Sửa</a>
                <a href="delete-category-post.php?id=<?= $c['cat_id'] ?>" class="text-danger font-weight-bold text-xs" onclick="return confirm('Bạn có chắc muốn xóa danh mục này?')"><i class="fas fa-trash"></i> Xóa</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
