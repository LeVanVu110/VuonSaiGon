...
$videos = $videoModel->getVideosPage($page, $perPage, $keyword);
$total = $videoModel->getTotal($keyword);
...
<body class="g-sidenav-show bg-gray-100">
     <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 200px);">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="../pages/video.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <div class="card mb-4 shadow-lg">
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
      <h6>Quản lý Video Youtube</h6>
      <div class="d-flex">
        <form method="GET" class="me-3">
          <input type="text" name="keyword" class="form-control" placeholder="Tìm tiêu đề..." value="<?= htmlspecialchars($keyword) ?>">
        </form>
        <a href="add-video.php" class="btn bg-gradient-info btn-sm mb-0">+ Thêm Video</a>
      </div>
    </div>
        ...
        <table class="table align-items-center mb-0 text-center">
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ảnh bìa</th>
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tiêu đề</th>
              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">YouTube ID</th>
          ...
          <tbody>
            ...
            <tr>
              <td><p class="text-xs font-weight-bold mb-0"><?= $v['video_id'] ?></p></td>
              <td><img src="<?= $v['image'] ?>" class="border-radius-lg" style="width:120px; height:auto;"></td>
              <td class="text-start"><h6 class="mb-0 text-sm"><?= $v['title'] ?: "[Chưa có tiêu đề]" ?></h6></td>
              <td><span class="text-xs font-weight-bold"><?= $v['youtube_id'] ?></span></td>
              <td class="align-middle">
                <a href="edit-video.php?id=<?= $v['video_id'] ?>" class="text-info font-weight-bold text-xs me-3"><i class="fas fa-edit"></i> Sửa</a>
                <a href="delete-video.php?id=<?= $v['video_id'] ?>" class="text-danger font-weight-bold text-xs" onclick="return confirm('Xóa video này?')"><i class="fas fa-trash"></i> Xóa</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
