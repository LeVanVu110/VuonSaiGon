...
if (isset($_POST['btn-save'])) {
    $contentModel->update($id, $_POST['tile'], $_POST['conntent']);
    header("Location: banner-content.php?success=updated");
}
    ...
    <div class="card-body">
      <form method="POST">
        <div class="row">
          <div class="col-12">
            <label>Tiêu đề</label>
            <input type="text" name="tile" class="form-control mb-3" value="<?= htmlspecialchars($item['tile'] ?? '') ?>" required>
          </div>
          <div class="col-12">
            <label>Nội dung (Hỗ trợ chèn link ảnh dạng src="...")</label>
            <textarea name="conntent" class="form-control mb-3" rows="15" required><?= $item['conntent'] ?? '' ?></textarea>
          </div>
        </div>
        <div class="d-flex justify-content-end mt-4">
          <a href="banner-content.php" class="btn btn-light m-0">Quay lại</a>
          <button type="submit" name="btn-save" class="btn bg-gradient-info ms-2 m-0">Lưu thay đổi</button>
        </div>
      </form>
    </div>
  </div>
